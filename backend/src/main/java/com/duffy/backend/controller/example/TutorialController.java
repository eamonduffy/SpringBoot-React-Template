...
public class TutorialController {
    ...
    @MutationMapping
    public Tutorial createTutorial(@Argument String title, @Argument String description, @Argument Integer id) {
    ...
    @MutationMapping
    public Tutorial updateTutorial(@Argument Integer id, @Argument String title, String description) {
